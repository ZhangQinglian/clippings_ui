...
public class DetailPresenter implements DetailContract.Presenter {
    ...
    @Override
    public void updateFavourite(Clipping clipping, int favourite) {
        UpdateFavourite updateFavourite = new UpdateFavourite();
        UseCaseHandler.getInstance().execute(updateFavourite, new UpdateFavourite.RequestValues(clipping, favourite), new UseCase.UseCaseCallback<UpdateFavourite.ResponseValue>() {
            @Override
